...
enum Direction{ 
  None(0d,0d){}, //Fixed set of methods that can be called 
  Up(0d,-1d){ //defualt parameters 
  ...
  Direction up(){return Up;} //returns final direction returned from methods above 
  ...
  Point arrow(Double speed){ return arrow.times(speed,speed);} //current location
  Direction(double x,double y){ arrow=new Point(x,y); } //after location 
}