...
interface Entity{
  ...
  default void drawImg(BufferedImage img, Graphics g, Point center, Dimension size){ //method that draws image 
    var l = location();
  ...
  Point location(); 
  default void location(Point p){ //Entities cannot be moved unless reimplemented 
